...
4. Click **Apply**. After the first deploy the app is live at **https://retailnexus.onrender.com** (or the URL shown in the dashboard). The app uses H2 in-memory on Render; data resets on redeploy or spin-down.
